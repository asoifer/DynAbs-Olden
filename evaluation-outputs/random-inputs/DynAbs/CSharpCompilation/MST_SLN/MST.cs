...
f_3_1356_1458(f_3_1356_1374(), "Build graph time " + DynAbs.Tracing.TraceSender.TraceInvocationWrapper(() => ((end0.Subtract(start0).TotalMilliseconds) / 1000.0).ToString(),3,1407,1457));
DynAbs.Tracing.TraceSender.TraceSimpleStatement(3,1464,1563);

f_3_1464_1562(f_3_1464_1482(), "Compute time " + DynAbs.Tracing.TraceSender.TraceInvocationWrapper(() => ((end1.Subtract(start1).TotalMilliseconds) / 1000.0).ToString(),3,1511,1561));
DynAbs.Tracing.TraceSender.TraceSimpleStatement(3,1568,1665);

f_3_1568_1664(f_3_1568_1586(), "Total time " + DynAbs.Tracing.TraceSender.TraceInvocationWrapper(() => ((end1.Subtract(start0).TotalMilliseconds) / 1000.0).ToString(),3,1613,1663));
