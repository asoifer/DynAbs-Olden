...
public partial class Root
{
	...
	{
		return (System.Math.Abs(D.P / 10000.0 - theta_R) < ROOT_EPSILON && System.Math.Abs(D.Q / 10000.0 - theta_I) < ROOT_EPSILON);
	}
	...
	public void nextIter(bool verbose)
	{
		...
		if(i > 35)
			i = 35;
		double d_theta_I = -(theta_I - D.Q / 10000.0) / (1.0 - (map_Q[i + 1] - map_Q[i]) / (PER_INDEX_I * 10000.0));

		if (verbose)
            System.Console.WriteLine("D TR-" + d_theta_R + ", TI=" + d_theta_I);
